...
namespace BSP
{
    GameWorldMpCompiler::GameWorldMpCompiler(MemoryManager& memory, ISearchPath& searchPath, AssetCreationContext& context)
        : m_memory(memory),
    ...
    bool GameWorldMpCompiler::linkGameWorldMp(ZoneAssetPools* T5AssetPool, std::string& mapName, std::string& bspName, std::string& T5BSPName)
    {
