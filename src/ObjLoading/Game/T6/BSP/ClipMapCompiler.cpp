...
namespace
{
    ...
    namespace CMBSPLinkingConstants
    {
    ...
    namespace CMBSPEditableConstants
    {
        ...
        constexpr int DEFAULT_SURFACE_LIGHT = CMBSPGameConstants::SUN_LIGHT_INDEX;
...
namespace BSP
{
    ...
    void ClipMapCompiler::loadPlanes(T5::clipMap_t* T5ClipMap, T6::clipMap_t* T6ClipMap)
    {
    ...
    void ClipMapCompiler::loadMaterials(T5::clipMap_t* T5ClipMap, T6::clipMap_t* T6ClipMap)
    {
        /*
        ...
        */
        ...
        T6ClipMap->info.materials[0].name = m_memory.Dup(CMBSPLinkingConstants::MISSING_IMAGE_NAME);
        T6ClipMap->info.materials[0].contentFlags = CMBSPEditableConstants::MATERIAL_CONTENT_FLAGS;
        T6ClipMap->info.materials[0].surfaceFlags = CMBSPEditableConstants::MATERIAL_SURFACE_FLAGS;
    }

    void ClipMapCompiler::loadBrushSides(T5::clipMap_t* T5ClipMap, T6::clipMap_t* T6ClipMap) // planes
    {
    ...
    void ClipMapCompiler::loadLeafBrushNodes(T5::clipMap_t* T5ClipMap, T6::clipMap_t* T6ClipMap) // leafbrushes
    {
    ...
    void ClipMapCompiler::loadLeafBrushes(T5::clipMap_t* T5ClipMap, T6::clipMap_t* T6ClipMap)
    {
    ...
    void ClipMapCompiler::loadBrushVerts(T5::clipMap_t* T5ClipMap, T6::clipMap_t* T6ClipMap)
    {
    ...
    void ClipMapCompiler::loadUinds(T5::clipMap_t* T5ClipMap, T6::clipMap_t* T6ClipMap)
    {
    ...
    void ClipMapCompiler::loadBrushes(T5::clipMap_t* T5ClipMap, T6::clipMap_t* T6ClipMap) // brushVerts, brushsides
    {
    ...
    bool ClipMapCompiler::loadStaticModels(T5::clipMap_t* T5ClipMap, T6::clipMap_t* T6ClipMap)
    {
    ...
    void ClipMapCompiler::loadNodes(T5::clipMap_t* T5ClipMap, T6::clipMap_t* T6ClipMap) // planes
    {
    ...
    void ClipMapCompiler::loadLeafs(T5::clipMap_t* T5ClipMap, T6::clipMap_t* T6ClipMap)
    {
    ...
    void ClipMapCompiler::loadVerts(T5::clipMap_t* T5ClipMap, T6::clipMap_t* T6ClipMap)
    {
    ...
    void ClipMapCompiler::loadTris(T5::clipMap_t* T5ClipMap, T6::clipMap_t* T6ClipMap)
    {
    ...
    void ClipMapCompiler::loadWalkableEdges(T5::clipMap_t* T5ClipMap, T6::clipMap_t* T6ClipMap)
    {
    ...
    void ClipMapCompiler::loadPartitions(T5::clipMap_t* T5ClipMap, T6::clipMap_t* T6ClipMap)
    {
    ...
    void ClipMapCompiler::loadAaBbs(T5::clipMap_t* T5ClipMap, T6::clipMap_t* T6ClipMap)
    {
    ...
    void ClipMapCompiler::loadSubModels(T5::clipMap_t* T5ClipMap, T6::clipMap_t* T6ClipMap)
    {
    ...
    void ClipMapCompiler::loadClusters(T5::clipMap_t* T5ClipMap, T6::clipMap_t* T6ClipMap)
    {
    ...
    void ClipMapCompiler::loadBoxHulls(T5::clipMap_t* T5ClipMap, T6::clipMap_t* T6ClipMap)
    {
    ...
    void ClipMapCompiler::loadDynEnts(T5::clipMap_t* T5ClipMap, T6::clipMap_t* T6ClipMap)
    {
    ...
    void ClipMapCompiler::loadConstraints(T5::clipMap_t* T5ClipMap, T6::clipMap_t* T6ClipMap)
    {
        // TODO: unimportant and too much work to implement right now
        // Remove constraints
    ...
    bool ClipMapCompiler::linkClipMap(ZoneAssetPools* T5AssetPool, std::string& mapName, std::string& bspName, std::string& T5BSPName)
    {
